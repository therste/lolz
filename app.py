...
WEBAPP_URL = os.getenv('WEBAPP_URL', 'https://blum-webapp.ru')
...
BOT_USERNAME = os.getenv('BOT_USERNAME', 'LolzTeamSafeBot')
...
DEFAULT_NEWS_URL = "https://t.me/lolzteam"
...
SUB_CHANNEL_URL = "https://t.me/lolzteam"
...
def get_main_keyboard(user_id):
    buttons = [
        ...
        [InlineKeyboardButton(text=get_str(user_id, "btn_support"), url="https://t.me/SafeLZT", style="danger", icon_custom_emoji_id="5893297890117292323")]
    ]
...
def get_requisites_keyboard(user_id):
    ...
    return InlineKeyboardMarkup(inline_keyboard=[
        ...
        [
            InlineKeyboardButton(text=get_str(user_id, "btn_top_up"), url="https://t.me/SafeLZT", style="success", icon_custom_emoji_id="5199552030615558774"),
...
async def pay_deal_handler(callback: types.CallbackQuery):
    ...
    if current_balance < amount:
        await safe_edit(callback.message, 
            ...
            reply_markup=InlineKeyboardMarkup(inline_keyboard=[
                [InlineKeyboardButton(text=get_str(buyer_id, "btn_top_up"), url="https://t.me/SafeLZT", style="success", icon_custom_emoji_id="5199552030615558774")],
                [InlineKeyboardButton(text=get_str(buyer_id, "btn_back"), callback_data="back_to_start", style="danger", icon_custom_emoji_id="5278702045883292456")]
            ]),
            parse_mode="HTML"
        )
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton(text=get_str(seller_id, "btn_contact_manager"), url="https://t.me/SafeLZT", style="danger", icon_custom_emoji_id="5467539229468793355")]
    ])
    try:
        photo = FSInputFile(IMAGE_PATH)
